...
REPORTS_FILE = r"D:\AntigravityProjects\solarguard-ai\frontend\src\components\Reports\ReportsHub.jsx"
...
with open(APP_FILE, "w", encoding="utf-8") as f:
    f.write(app_code)
print("Updated App.jsx with all new routes!")
