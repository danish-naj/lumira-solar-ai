...
SUBS_DIR = r"D:\AntigravityProjects\solarguard-ai\frontend\src\components\Subscription"
os.makedirs(SUBS_DIR, exist_ok=True)

subs_file = os.path.join(SUBS_DIR, "SubscriptionROIView.jsx")
...
print("Created SubscriptionROIView.jsx")
